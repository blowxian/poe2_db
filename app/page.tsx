        ...
        <div className="bg-black text-gray-300 font-sans min-h-screen">
            ...
            <main className="max-w-5xl mx-auto p-6">
                ...
                <section id="features" className="mb-12">
                    ...
                    <p>
                        Whether youre a new player or a veteran, this <strong>poe2 guide</strong> will help you navigate through these features to maximize your gameplay experience.
                    </p>
                </section>
                ...
                <section id="early-access" className="mb-12">
                    ...
                    <p>
                        Path of Exile 2s Early Access begins on December 6, 2024, and will be available on PC, PlayStation 5, and Xbox Series X/S.
